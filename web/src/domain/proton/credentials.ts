...
import { credentialStore } from '@/shared/host';
import { SESSION_KEY } from '@/shared/lib/storageKeys';
...
// macOS Keychain on desktop — see credentialStore in host/).

type Stored = { session?: SessionInfo; userKeyPassword?: string };

const store = credentialStore(SESSION_KEY);
